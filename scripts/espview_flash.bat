...
REM
REM   Usage:
REM     scripts\espview_flash.bat [flash] [-p COM4] [-b <profile>]
...
echo ============================================================
echo ESPView flash: port=%PORT% baud=%BAUD% profile=%ESP32_PROFILE%
...
echo.
echo Usage: scripts\espview_flash.bat [flash] [-p COM4] [-b ^<profile^>] [--no-reset] [--dry-run]
