...
const std::map<std::string, std::string>& enDict() {
    static const std::map<std::string, std::string> kEn = {
        ...
        {"Close", "Close"},
        {"Retry", "Retry"},
        // ---- M7-D4 Wi-Fi Wizard（步骤标题 + 错误 + 对话框文案）----
        {"Connect ESP32", "Connect ESP32"},
        {"Read Capabilities", "Read Capabilities"},
        {"Scan Wi-Fi", "Scan Wi-Fi"},
        {"Select SSID", "Select SSID"},
        {"Enter Password", "Enter Password"},
        {"TCP Server Config", "TCP Server Config"},
        {"Applying", "Applying"},
        ...
        {"SSID too long (max 32 characters)", "SSID too long (max 32 characters)"},
        {"SSID contains invalid characters", "SSID contains invalid characters"},
        {"Password too short (min 8 characters)", "Password too short (min 8 characters)"},
        {"Password too long (max 63 characters)", "Password too long (max 63 characters)"},
        {"Invalid TCP server IP", "Invalid TCP server IP"},
        {"UART connection failed", "UART connection failed"},
        {"Capability read failed", "Capability read failed"},
        {"Wi-Fi scan failed", "Wi-Fi scan failed"},
        {"Apply failed", "Apply failed"},
        {"Wi-Fi connection failed", "Wi-Fi connection failed"},
        {"No IP address received", "No IP address received"},
        {"TCP connection failed", "TCP connection failed"},
        {"Full resync failed", "Full resync failed"},
        {"Next", "Next"},
        {"Back", "Back"},
        {"Scan", "Scan"},
        {"Scanning...", "Scanning..."},
        ...
        {"Open network (no password)", "Open network (no password)"},
        {"Server IP", "Server IP"},
        {"No Wi-Fi networks found", "No Wi-Fi networks found"},
        {"Firmware does not support Wi-Fi provisioning", "Firmware does not support Wi-Fi provisioning"},
        {"Wi-Fi provisioning", "Wi-Fi provisioning"},
        {"Wi-Fi provisioning complete", "Wi-Fi provisioning complete"},
        {"Wi-Fi provisioning failed", "Wi-Fi provisioning failed"},
        {"Password is stored in memory only and cleared after apply", "Password is stored in memory only and cleared after apply"},
        {"This wizard configures Wi-Fi over the UART bootstrap link", "This wizard configures Wi-Fi over the UART bootstrap link"},
        {"Connect the ESP32 to this PC over UART first", "Connect the ESP32 to this PC over UART first"},
        {"Waiting for the device capabilities", "Waiting for the device capabilities"},
        {"Click Scan to search for nearby Wi-Fi networks", "Click Scan to search for nearby Wi-Fi networks"},
        {"Select the network to configure", "Select the network to configure"},
        {"Leave empty for an open network", "Leave empty for an open network"},
        {"ESP32 will connect to this TCP server after GOT_IP", "ESP32 will connect to this TCP server after GOT_IP"},
        {"Applying configuration to ESP32...", "Applying configuration to ESP32..."},
        {"ESP32 is connecting to Wi-Fi...", "ESP32 is connecting to Wi-Fi..."},
...
const std::map<std::string, std::string>& zhDict() {
    static const std::map<std::string, std::string> kZh = {
        ...
        {"Wi-Fi provisioning requires the UART bootstrap link", "Wi-Fi 配网需要使用 UART 引导链路"},
